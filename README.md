...
- **Интеллектуальный Telegram-бот (`grammY`)**:
  - Выбор качества видео от 360p до 4K 2160p Ultra HD с отображением бейджей разрешений.
  ...
  - Раздел «Запланированное» с фильтрацией по активному колокольчику и постраничной навигацией.
...
- **Гостевой режим и устойчивость к сети**:
  - Полная работоспособность бота при отсутствии, отзыве или истечении токенов Shikimori: бот автоматически переходит в локальный режим `AnimeLib ➔ SQLite` и продолжает трекинг и скачивание серий.
